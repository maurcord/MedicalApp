...
$(function () { 
   ...
   [{ name: "John Doe", doctor: "10", time:"9:00 am", date: "04/21/21", id:"1"},
    { name: "Jane Doe", doctor: "22", time:"10:00 am", date: "04/21/21", id:"2"},
    { name: "Jake Doe", doctor: "31", time:"9:30 am", date: "04/21/21", id:"3"},
    { name: "Jordan Doe", doctor: "32", time:"8:00 am", date: "04/21/21", id:"4"},
    { name: "Justin Doe", doctor: "52", time:"8:30 am", date: "04/21/21", id:"5"},
    { name: "Jill Doe", doctor: "14", time:"9:30 am", date: "04/21/21", id:"6"},
    { name: "John Doe", doctor: "10", time:"11:00 am", date: "04/21/21", id:"7"},
    { name: "Jane Doe", doctor: "22", time:"9:30 am", date: "04/21/21", id:"8"},
    { name: "Jake Doe", doctor: "31", time:"10:30 am", date: "04/21/21", id:"9"},
    { name: "Jordan Doe", doctor: "32", time:"9:00 am", date: "04/21/21", id:"10"},
    { name: "Justin Doe", doctor: "52", time:"9:00 am", date: "04/21/21", id:"11"},
    { name: "Jill Doe", doctor: "14", time:"11:00 am", date: "04/21/21", id:"12"},
    { name: "John Doe", doctor: "10", time:"8:00 am", date: "04/21/21", id:"13"},
    ...
    $("#exampleform2").kendoForm({
        ...
        items: [{
            ...
            items: [
                ...
                { field: "Time", label: "Time:", validation: { required: true} },
                { field: "Date", editor: "DatePicker", label: "Date:", validation: { required: true} },
                { field: "Description", label: "Reason:", editor:function(container, options) {
